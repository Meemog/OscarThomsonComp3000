            ...
            auth.then((data) => {
                if(data.loggedIn){
                    if(data.data!.type === "clock"){
                        ...
                        window.location.replace(`http://${url.hostname}:${url.port}/clock`)
                    }
                }
...
function LoginPage(): ReactNode {
    ...
    async function verifyClock(): Promise<boolean> {
    ...
    return(
        ...
        <div className="mx-auto w-full max-w-md">
            <h1 className="text-2xl text-center mb-2">Please log in to a clock management account</h1>
